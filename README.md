...
The GUI is built with Tauri, Vite, React, and TypeScript. Crawling, queueing, storage, exports, and AI analysis run in a Node.js v22 local service. The hard-coded Quanben5 adapters target the Big5 and Simplified Quanben5 source sites.
...
The Quanben5 adapters extract book metadata, catalog entries, and authorized chapter content from user-provided source URLs. Downloader behavior is rate-limited and records source attribution.
